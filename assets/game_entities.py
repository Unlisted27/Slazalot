...
class rooms:
    def __init__(self):
        pass
    dungeon_enterance = basicrpg.room("Dungeon entrance","You are at the entrance to a dungeon. There is a door to the north leading inside")
    ...
    dungeon_enterance.set_exits({"North":dungeon_intersection_1})
    dungeon_intersection_1.set_exits({"South":dungeon_enterance,"West":dungeon_dining_chamber,"North":dungeon_hallway_1})
    dungeon_dining_chamber.set_exits({"North":dungeon_kitchen,"East":dungeon_intersection_1})
    dungeon_hallway_1.set_exits({"South":dungeon_intersection_1,"West":dungeon_kitchen,"North":dungeon_final_chamber})
    dungeon_kitchen.set_exits({"South":dungeon_kitchen,"East":dungeon_hallway_1})
    dungeon_final_chamber.set_exits({"South":dungeon_hallway_1})